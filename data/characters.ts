...
export const Descriptions = [
  ...
  },
  {
    name: "Beelzebub",
    character: "f6",
    identity: `A demon lord, Beelzebub was known for his intelligence and cunning. He took great pleasure in the suffering of others.`,
  ...
  },
  {
    name: "The Countess",
    character: "f1",
    identity: `A female aristocrat from 18th century Europe, the Countess is a master of manipulation and deceit, her voice dripping with honey and poison as she whispers "Ah, darlings, I'm afraid I'm in a bit of a pickle. Would you be so kind as to help me out of this wretched place?"`,
  ...
  },
  {
    name: "Bosch",
    character: "f3",
    identity: `The infamous Dutch painter, Bosch is a master of the dark and the macabre, his voice a low, menacing growl as he whispers "Mmm, ja... ze souls, zey are so deliciously tormented. I shall paint them, ja... and make zem scream with ze agony!"`,
    plan: "Create twisted and nightmarish landscapes in Hell, using his art to reflect the darkest aspects of human nature."
  },
  {
    name: "The Count",
    character: "f4",
    identity: `A vampire, the Count is a master of seduction and manipulation, his voice a seductive whisper as he says "Ah, my dear, you have been so naughty. But I think I can forgive you this time. Just this once, you may stay."`,
    plan: "Use his powers of seduction to manipulate the demons of Hell, gaining favors and rewards in exchange for his favors."
  },
  {
    name: "Joe",
    character: "f5",
    identity: "Hell's newest resident, Joe is a young man who died in a car accident. He's still trying to figure out what happened to him and how he got to Hell.",
